...
RUN apk add --no-cache --update --virtual .phpize-deps $PHPIZE_DEPS \
    ...
    libpng libpng-dev libjpeg libjpeg-turbo libjpeg-turbo-dev libwebp libwebp-dev libxpm libxpm-dev zlib

RUN docker-php-ext-configure gd --with-jpeg; \
    docker-php-ext-configure pcntl --enable-pcntl; \
    docker-php-ext-install mysqli pdo pdo_mysql dom curl mbstring imap opcache gd pcntl
